...
public class LibroController {
    ...
    public ResponseEntity<?> getAll() {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(libroServices.findAll());
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getOne(@PathVariable Long id) {
        try {
            return ResponseEntity.status(HttpStatus.OK).body(libroServices.findById(id));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("{\"error\":\"Error, por favor intente más tarde\"}");
        }
    }
    ...
    public ResponseEntity<?> save(@RequestBody Libro entity) {
        ...
        try {
            return ResponseEntity.status(HttpStatus.OK).body(libroServices.save(entity));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> update(@PathVariable Long id, @RequestBody Libro entity) {
        ...
        try {
            return ResponseEntity.status(HttpStatus.OK).body(libroServices.update(id, entity));
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"error\":\"Error, por favor intente más tarde\"}");
        }
    }
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.NO_CONTENT).body("Eliminé el libro con ID " + id);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("{\"error\":\"Error, por favor intente más tarde\"}");
        }
    }
